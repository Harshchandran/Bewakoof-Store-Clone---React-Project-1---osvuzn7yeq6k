...
export const Footer = () => {
  return (
    <>
      <div>Footer</div>
      <footer>
        <section className="footerSecondaryBox">
          <h4 className="footerSecondaryHeader">
            BEWAKOOF® THE NEW AGE ONLINE SHOPPING EXPERIENCE.
          </h4>
          <p className="footerSecondaryText">
          ...
          <h4 className="footerSecondaryHeader">OUR PHILOSOPHY</h4>
          <p className="footerSecondaryText">
